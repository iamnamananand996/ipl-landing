  ...
  return (
    <div className="h-full relative bg-white">
      <div className="w-full h-[800px] left-[-1px] top-0 absolute">
        <img
          className="h-[800px] left-0 top-0 absolute"
          src="/bg-hero.svg"
        />
      ...
      <div className="w-[1980px] h-[760px] left-[2px] top-[1666px] absolute">
        <img
          className="w-[1980px] h-[760px] left-0 top-0 absolute"
          src="/bg-hero-2.svg"
        />
      ...
      <div className="w-[1979px] h-[866px] left-0 top-[800px] absolute">
        <div className="w-[1979px] h-[866px] left-0 top-0 absolute bg-yellow-200" />
        <div className="w-[715px] h-[283px] left-[889px] top-[312px] absolute text-yellow-950 text-opacity-95 text-2xl font-normal font-['Inter']">
          Over the years as the World Cup has evolved to be a bigger and better
          platform for competing for the ultimate glory in the world of cricket,
          records are being made and broken at will and weird instances and
          events continue to dot the global spectrum of international cricket.
          Here are some of the most interesting facts about the ICC World Cup
          from its glorious years in history
        </div>
      ...
      <div className="w-[1978px] h-[844px] left-[2px] top-[2426px] absolute">
        <img
          className="w-[1978px] h-[844px] left-0 top-0 absolute"
      ...
      <div className="w-[1979px] h-[127px] left-0 top-[3143px] absolute">
        <div className="w-[1979px] h-[127px] left-0 top-0 absolute bg-black" />
